...
{
    resize(850, 550);
    setWindowTitle(tr("Ghostprotocol") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ghostprotocol address"));
    ...
    manageNamesAction->setStatusTip(tr("Manage names registered via Ghostprotocol"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Ghostprotocol"), this);
    aboutAction->setStatusTip(tr("Show information about Ghostprotocol"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Ghostprotocol"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ghostprotocol addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ghostprotocol addresses"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    if (!GetBoolArg("-testnet"))
    {
        trayIcon->setToolTip(tr("Ghostprotocol client"));
        trayIcon->setIcon(QIcon(":/icons/toolbar"));
    }
    else
    {
        trayIcon->setToolTip(tr("Ghostprotocol client") + QString(" ") + tr("[testnet]"));
        trayIcon->setIcon(QIcon(":/icons/toolbar_testnet"));
    }
    trayIcon->show();
#endif
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Ghostprotocol network", "", count));
}
...
{
    QString strTitle = tr("Ghostprotocol") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Ghostprotocol address or malformed URI parameters."),
