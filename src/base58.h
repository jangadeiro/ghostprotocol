...
// everywhere (and called just CSecret); in the current Ghostprotocol implementation it is only used for
...
// Note: Ghostprotocol implementation uses a hack: CSecret32 is used here, everywhere else
