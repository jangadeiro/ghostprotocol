...
uint256 hashGenesisBlock("0xbf67dbeacfe0c17815788e71619dab48fa711962a1dd4507dda4af583f91399f");
...
{
    const int64 nTargetTimespan = 14 * 24 * 60 * 60; // 14 days
...
/* Temporary check that blocks are compatible with BDB's 10,000 lock limit.
   ...
   In addition, each Ghostprotocol transaction could touch at most one name,
   so add them as well.  */
static bool
...
CheckDiskSpace (uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < (uint64)15000000 + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
#ifdef GUI
        uiInterface.ThreadSafeMessageBox(strMessage, "Ghostprotocol", wxOK | wxICON_EXCLAMATION);
#else
        ThreadSafeMessageBox(strMessage, "Ghostprotocol", wxOK | wxICON_EXCLAMATION);
#endif
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        hashGenesisBlock = uint256("0xbf67dbeacfe0c17815788e71619dab48fa711962a1dd4507dda4af583f91399f");
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Back To The Future!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("123afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f") << OP_CHECKSIG;
        CBlock block;
        ...
        if (!hooks->GenesisBlock(block))
        {
            ...
            assert(block.hashMerkleRoot == uint256("0xb7f0118466fbe42d27ca18aa6aa3bb1f2aec2a7754a80df614399a8985ddb5f3"));
...
char pchMessageStart[4] = { 0xd2, 0xc3, 0xb4, 0xd9 };
